...
class _LoginState extends State<Login> {
  ...
  Widget build(BuildContext context) {
    ...
    //更改userInfo
    _modifyUserInfo(TextEditingController account,TextEditingController password) async {
      SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setString('account', account.text);
            ...
            child: Column(
              children: [
                ...
                Container(
                    ...
                    child: TextField(
                      controller: account..text = iniAccount,
                ...
                Container(
                    ...
                    child: TextField(
                      controller: password..text = iniPassword,
                      keyboardType: TextInputType.text,
                      style: const TextStyle(
                        fontSize: 30,
                        fontWeight: FontWeight.w500,
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          if (account.text == '') {
                          ...
                          } else if (!stringFilter(account.text) ||
                              !stringFilter(password.text)) {
                            showDialog(
                              context: context,
                              builder: (BuildContext context) => AlertDialog(
                                title: const Text('錯誤'),
                            ...
                            //與server溝通
                            Socket socket =
                                await Socket.connect('140.117.168.12', 54915);
                            print(
                            ...
                            socket.listen((List<int> event) async {
                              ...
                              } else if (severMsg == 'success;') {  //登入成功
                                //關閉socket
                                socket.close();

                                //更改UsrInfo
                                _modifyUserInfo(account,password);
